...
namespace RobotWorkstation
{
    ...
    {
        private static VisionCamera m_UniqueVisionCamera = null;
        ...
        public bool m_CameraConnect = false;
        ...
        {
            if (m_UniqueVisionCamera == null)
            {
                lock (m_Locker)
                {
                    if (m_UniqueVisionCamera == null)
                        m_UniqueVisionCamera = new VisionCamera();
                }
            }
            return m_UniqueVisionCamera;
        }
